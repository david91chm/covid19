<div class="page-header">
	<h1>Anestesia - Reanimación</h1>
</div>

<button class="btn myButton" type="button">
	<span class="glyphicon glyphicon-chevron-right"></span> Lista de verificación de intubación
</button>
...
<button class="btn myButton" type="button">
	<span class="glyphicon glyphicon-chevron-right"></span> Vídeo de intubación
</button>
<div class="collapse" id="collapseExample1">
	<div class="well">
...
<button class="btn myButton" type="button">
	<span class="glyphicon glyphicon-chevron-right"></span> Drogas
</button>
<div class="collapse" id="collapseExample1">
	<div class="well">
...
<button class="btn myButton" type="button">
	<span class="glyphicon glyphicon-chevron-right"></span> Curva volúmen actual (Vt)/tamaño
</button>
<div class="collapse" id="collapseExample1">
	<div class="well">
...
<button class="btn myButton" type="button">
	<span class="glyphicon glyphicon-chevron-right"></span> ECMO - Contraindicaciones
</button>
<div class="collapse" id="collapseExample1">
	<div class="well">
...
<button class="btn myButton" type="button">
	<span class="glyphicon glyphicon-chevron-right"></span> ECMO - Algoritmo de decisión
</button>
<div class="collapse" id="collapseExample1">
	<div class="well">
